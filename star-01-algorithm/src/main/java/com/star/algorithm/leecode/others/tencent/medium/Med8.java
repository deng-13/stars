 ...
 * 说明：
 *
 * 假设我们的环境只能存储 32 位大小的有符号整数，那么其数值范围为 [−231,  231 − 1]。如果数值超过这个范围，请返回  INT_MAX (231 − 1) 或 INT_MIN
 * (−231) 。
 *
 * 示例 1:
 *
...
public class Med8 {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(solution8_1.myAtoi(str));
  }
}
...
class Solution8_1 {
  ...
  public int myAtoi(String str) {
    ...
    if ((firstChar >= '0' && firstChar <= '9') || firstChar == '-' || firstChar == '+') {
      ...
      if (str.substring(0, i).equals("+") || str.substring(0, i).equals("-")) {
        return 0;
      }

      Long result = Long.valueOf(str.substring(0, i));
